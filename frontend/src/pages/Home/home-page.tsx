...
const slides = [
  {
    ...
    title: "Mission",
    content:
      "Empower through trustworthy rent management, fostering financial well-being and lasting trust.",
  },
  {
    id: 2,
    title: "Vision",
    content:
      "Redesigning rent management for real-time connections, innovative tools, and financial empowerment.",
  },
  {
    id: 3,
    title: "Values",
    content:
      "Guided by integrity, collaboration, and user empowerment to redefine the rent management experience.",
  },
];
